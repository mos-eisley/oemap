...
# A tervlapi kóddal (OA00F11) való megfeleltetés nem itt van, hanem az app
# NEPTUN táblájában (index.html): a térkép feliratai már induláskor abból
# dolgoznak, a teremadat betöltése előtt.
